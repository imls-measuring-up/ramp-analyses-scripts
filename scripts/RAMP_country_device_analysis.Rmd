...
Table 5 is a representation of the information in the file _RAMP_summary_stats_20200109.csv_, sorted by IR country and organizational type (university or consortia). The table in the article is formatted somewhat differently, but the following code block provides the necessary logic.
...
```{r import_country_device_RAMP_data}
